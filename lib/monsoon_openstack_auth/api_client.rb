  ...
  class ApiClient
    ...
    def initialize(region)
      @connection = Fog::IdentityV3::OpenStack.new({
        ...
        openstack_auth_url: MonsoonOpenstackAuth.configuration.api_endpoint,
        openstack_userid:   MonsoonOpenstackAuth.configuration.api_userid,
        openstack_api_key:  MonsoonOpenstackAuth.configuration.api_password
      })
      self
    end
