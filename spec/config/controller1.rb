...
module MonsoonOpenstackAuth1
  module Controller
    ...
    module ClassMethods
      ...
      def authorization_actions_for(model)
    ...
    module InstanceMethods
      ...
      def enforce params
        ...
        if @authority_model
          ...
          authority_model = controller_name
        end
        application_name = MonsoonOpenstackAuth.configuration.authorization_context
        os_action = "#{application_name}:#{authority_model}_#{authority_action}"
