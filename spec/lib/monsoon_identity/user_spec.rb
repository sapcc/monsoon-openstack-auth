...
describe MonsoonIdentity::User do
  shared_examples_for "an user" do
    ...
    context "User initialized" do
      let(:user) {user = MonsoonIdentity::User.new(region,token)}
      ...
      describe "user_domain_id" do
        it "should return user domain id" do
          ...
          if user_domain_id
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"user"=>{"domain"=>{"id" => "test"} } }))
      ...
      describe "user_domain_name" do
        it "should return user domain name" do
          ...
          if user_domain_name
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"user"=>{"domain"=>{"name" => "test"} } }))
      ...
      describe "domain_id" do
        it "should return domain_id" do
          ...
          if domain_id
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"domain"=>{"id" => "test"} } ))
      ...
      describe "domain_name" do
        it "should return domain_name" do
          ...
          if domain_name
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"domain"=>{"name" => "test"} } ))
      ...
      describe "project_id" do
        it "should return project_id" do
          ...
          if project_id
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"project"=>{"id" => "test"} } ))
      ...
      describe "project_name" do
        it "should return project_name" do
          ...
          if project_name
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"project"=>{"name" => "test"} } ))
      ...
      describe "project_domain_id" do
        it "should return project_id" do
          ...
          if project_domain_id
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"project"=>{"id" => "test", "domain"=> {"id"=>"test"} } } ))
      ...
      describe "project_domain_name" do
        it "should return project_name" do
          ...
          if project_domain_name
            ...
            new_user = MonsoonIdentity::User.new(region,token.merge({"project"=>{"name" => "test", "domain"=> {"name"=>"test"} } } ))
      ...
      describe "admin?" do
        ...
        context "token contains admin role" do
          it "should return true" do
            new_user = MonsoonIdentity::User.new(region,token.merge({"roles"=>[{"name"=>"admin"}] }))
        ...
        context "token does not contain admin role" do
          it "should return false" do
            ...
            new_user = MonsoonIdentity::User.new(region,new_token)
      ...
      describe "default_services_region" do
        ...
        it "should return europe" do
          new_user = MonsoonIdentity::User.new('europe',token)
      ...
      describe "available_services_regions" do
        it "should return ['europe','us']" do
          ...
          new_user = MonsoonIdentity::User.new('europe',new_token)
