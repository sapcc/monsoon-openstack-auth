...
describe MonsoonIdentity::Session do
  before(:each) do
  ...
  describe "initialize" do
    it "should create a new session object" do
      session = MonsoonIdentity::Session.new(@controller, 'europe')
  ...
  #
  #     @controller.stub(:session){ {monsoon_identity_token: ApiStub.keystone_token.merge("expires_at"=>Time.now+1.hour)} }
  #
  #
  #   end
  #
